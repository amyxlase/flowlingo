...
let APIKey = "AIzaSyCgJFtQz4X7JYJ4z92viV_goEvp1mtV57c"
...
class SpeechService: NSObject, AVAudioPlayerDelegate {
    ...
    func speak(text: String, voiceType: String, completion: @escaping () -> Void) {
    ...
    private func buildPostData(text: String, voiceType: String) -> Data {
        ...
        var voiceParams: [String: Any] = [
            ...
            "languageCode": voiceType.prefix(5) // Hello
        ]
