...
//
// Minor Modification: A "code" variable was added on 9/18/2018 in order to externally choose the
...
let API_KEY : String = "AIzaSyCgJFtQz4X7JYJ4z92viV_goEvp1mtV57c"
  ...
  func streamAudioData(_ audioData: NSData, completion: @escaping SpeechRecognitionCompletionHandler) {
    if (!streaming) {
      ...
      recognitionConfig.sampleRateHertz = Int32(sampleRate)
        recognitionConfig.languageCode = code;
